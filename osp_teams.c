...
//=============================================================================
//
// The three scoreboard renderers and the team-chat command.  Same object as the
// team code above: real pads this object's .rodata to 4 at its start (the float
// constants below give it that alignment) and not at the join, and real's DLL
// starts OSP_showTeamScores at an unaligned 1003C185 with no int3.  Being in
// one TU is also what lets -O3 inline OSP_teamCount into the scoreboards, the
// loop real's ELF has inline and real's DLL calls.
//
