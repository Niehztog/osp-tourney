...
static q_unused bool    enemy_vis;
static q_unused int     enemy_range;
...
static q_unused void ai_run_melee(edict_t *self)
{
...
static q_unused void ai_run_missile(edict_t *self)
{
    self->ideal_yaw = enemy_yaw;
    M_ChangeYaw(self);
