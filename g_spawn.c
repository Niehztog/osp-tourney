...
static const spawn_field_t temp_fields[] = {
    ...
    // tourney's own keys: the bot library to load, and the four the `bot`
    // entity carries
...
// timer 2 (pent) -- slots 29/30, not Q2PRO's 18/19, which tourney uses
"if 29 "
  "yb -76 "
  "xv 262 "
  "num 2 30 "
...
void SP_worldspawn(edict_t *ent)
{
    ...
    gi.configstring(game.csr.maxclients, va("%i", (int)(game.maxclients)));
