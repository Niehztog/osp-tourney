...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10006090..10006127
// gamei386.so: 0007ADF8..0007AEBF
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10006127..1000616A
// gamei386.so: 0007AEC0..0007AF09
...
//                              botglobals.numbots
//===========================================================================
// gamex86.dll: 1000616A..10006215
// gamei386.so: 0007AF0C..0007AFB5
...
//                              botglobals.numbots
//===========================================================================
// gamex86.dll: 10006215..10006337
// gamei386.so: 0007AFB8..0007B111
...
//                              botglobals.numbots
//===========================================================================
// gamex86.dll: 10006337..100064B3
// gamei386.so: 0007B114..0007B2B5
...
// Changes Globals:     botglobals.botstates
//===========================================================================
// gamex86.dll: 100064B3..10006654
// gamei386.so: 0007B2B8..0007B46A
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10006654..100066F4
// gamei386.so: 0007B46C..0007B502
void BotSpawn(void)
{
    int i;
    edict_t *cl_ent;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 100066F4..100066F9
// gamei386.so: 0007B504..0007B509
...
// gamex86.dll: 100066F9..100066FE
// gamei386.so: 0007B50C..0007B511
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 100066FE..10006796
// gamei386.so: 0007B514..0007B5AC
void AddBotToQueue(edict_t *ent, char *library, char *userinfo)
{
    ...
    memcpy(bot->userinfo, userinfo, MAX_INFO_STRING-1);
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10006796..1000689A
// gamei386.so: 0007B5AC..0007B68D
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 1000689A..1000690A
// gamei386.so: 0007B690..0007B707
bool ClientNameExists(char *name)
{
    int i;
    edict_t *cl_ent;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 1000690A..10006B53
// gamei386.so: 0007B708..0007BB2B
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10006B53..10006BE5
// gamei386.so: 0007BB2C..0007BC71
...
// gamex86.dll: 10006BE5..10006C27
// gamei386.so: 0007BC74..0007BCBF
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10006C27..10006D3D
// gamei386.so: 0007BCC0..0007BDDB
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10006D3D..10006F90
// gamei386.so: 0007BDDC..0007C031
void CheckMinimumPlayers(void)
{
    ...
    // The local is spelled after the cvar it holds, this tree's convention.
    ...
    //
#ifdef TOURNEY
    // The bots_autoload == 4 case is its OWN arm, not the first half of one
    // `||`; the removebot arm's own test is a wrap, not a guard-return.
    if ((int)bots_autoload->value == 4 && numbots < (int)minplayers->value)
    {
    ...
    else if (((numplayers - bots_votedin - 1) < (int)minplayers->value) &&
      (numplayers < (int)game.maxclients) && numbots < (int)minplayers->value &&
      old_botcount != numbots)
#else
    ...
    {
        if ((numplayers - bots_votedin - 1) > (int)minplayers->value)
        {
