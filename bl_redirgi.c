...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005070..100050C5
// gamei386.so: 00079BC4..00079C24
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 100050C5..10005180
// gamei386.so: 00079C24..00079CB8
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005180..100051C2
// gamei386.so: 00079CB8..00079CFB
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 100051C2..10005204
// gamei386.so: 00079CFC..00079D3F
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005204..10005246
// gamei386.so: 00079D40..00079D83
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005246..10005276
// gamei386.so: 00079D84..00079DB0
...
// gamex86.dll: 10005276..1000537A
// gamei386.so: 00079DB0..00079EB7
...
// gamex86.dll: 1000537A..1000545E
// gamei386.so: 00079EB8..00079F9E
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 1000545E..10005538
// gamei386.so: 00079FA0..0007A06A
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005538..100055DC
// gamei386.so: 0007A06C..0007A0EC
void Bot_cprintf(edict_t *ent, int printlevel, const char *fmt, ...)
{
    char str[2048];
    va_list ap;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 100055DC..10005642
// gamei386.so: 0007A0EC..0007A142
void Bot_centerprintf(edict_t *ent, const char *fmt, ...)
{
    char str[2048];
    va_list ap;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005642..10005728
// gamei386.so: 0007A144..0007A1F1
void Bot_bprintf(int printlevel, const char *fmt, ...)
{
    int j;
    char str[2048];
    edict_t *other;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005728..1000576E
// gamei386.so: 0007A1F4..0007A240
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 1000576E..1000580B
// gamei386.so: 0007A240..0007A2ED
int Bot_modelindex(const char *name)
{
    int i;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 1000580B..100058A8
// gamei386.so: 0007A2F0..0007A39D
int Bot_soundindex(const char *name)
{
    int i;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 100058A8..10005945
// gamei386.so: 0007A3A0..0007A44D
int Bot_imageindex(const char *name)
{
    int i;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005945..100059D0
// gamei386.so: 0007A450..0007A4E4
void Bot_setmodel(edict_t *ent, const char *name)
{
    int i;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 100059D0..10005A12
// gamei386.so: 0007A4E4..0007A508
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005A12..10005A3E
// gamei386.so: 0007A508..0007A51E
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005A3E..10005A79
// gamei386.so: 0007A520..0007A55D
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005A79..10005A92
// gamei386.so: 0007A560..0007A58E
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005A92..10005B4D
// gamei386.so: 0007A590..0007A683
void Bot_multicast(const vec3_t origin, multicast_t to)
{
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005B4D..10005B9D
// gamei386.so: 0007A684..0007A70F
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005DAD..10005DFF
// gamei386.so: 0007A920..0007AA55
void Bot_WritePosition(const vec3_t pos)
{
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005DFF..10005E25
// gamei386.so: 0007AA58..0007AABA
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005E25..10005EED
// gamei386.so: 0007AABC..0007AB8E
void Bot_WriteDir(const vec3_t dir)
{
    int j, maxdotindex;
    float dot, maxdot;
    vec3_t v;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005EED..10005F2F
// gamei386.so: 0007AB90..0007ABD3
int Bot_argc(void)
{
    int i;
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005F2F..10005F5A
// gamei386.so: 0007ABD4..0007AC08
char *Bot_argv(int n)
{
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005F5A..10005F75
// gamei386.so: 0007AC08..0007AC3F
char *Bot_args(void)
{
...
// Changes Globals:     -
//===========================================================================
// NOT in the real image: this SDK path was cut, and the mod precaches its
// runes from its own rune TU.
#if 0
// gamex86.dll: absent
// gamei386.so: absent
...
// Changes Globals:     -
//===========================================================================
// gamex86.dll: 10005F75..10006090
// gamei386.so: 0007AC40..0007ADF7
